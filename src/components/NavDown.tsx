  ...
  return (
    <div>
      <Flex gap="4" justify="space-between" padding='2'>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="10" height="30" viewBox="0 0 10 378" fill="none">
          <line x1="5" y1="0" x2="5" y2="3780" stroke="#FFF" stroke-width="20" />
          </svg>
          ...
          <Text color="fg.inverted">TRIMS & FLASHING</Text>
          <svg xmlns="http://www.w3.org/2000/svg" width="10" height="30" viewBox="0 0 10 378" fill="none">
          <line x1="5" y1="0" x2="5" y2="3780" stroke="#FFF" stroke-width="20" />
          </svg>
